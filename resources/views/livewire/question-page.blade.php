<div class="flex items-center justify-center min-h-screen bg-gray-100" translate="no">
                ...
                <form wire:submit="submitResponses">
                    {{-- <ul class="space-y-4">
                        @foreach ($responses as $index => $response)
                            <li class="flex flex-col p-4 border rounded-lg shadow hover:bg-gray-50">
                                <p class="mb-2 text-center">{{ $response->question->text }}</p>

                                <div class="flex flex-row item-center justify-evenly space-x-4">
                                    ...
                                    <div class="flex space-x-4">
                                        <label class="flex items-center">
                                            ...
                                            <input type="radio" name="user_response_{{ $index }}"
                                                ...
                                                class="mr-2 ml-2" style="transform: scale(1.3);">
                                        </label>
                                        <label class="flex items-center">
                                            <input type="radio" name="user_response_{{ $index }}"
                                                wire:model.live="userAnswers.{{ $index }}" value="0"
                                                class="mr-2" style="transform: scale(1.3);">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-10">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @if ($currentResponse)
                            ...
                            @if ($currentResponse->question->image)
                                <div class="flex justify-center my-4">
                                    <img src="{{ asset('storage/' . $currentResponse->question->image) }}" class="w-64 h-64" alt="Question Image">
                                </div>
                            @endif
                            ...
                            <div class="flex justify-center space-x-4">
                                <label class="flex items-center">
                                    ...
                                    <input type="radio" name="user_response_{{ $currentQuestionIndex }}"
                                        wire:model.live="userAnswers.{{ $currentQuestionIndex }}" value="1"
                                        class="mr-2 ml-2" style="transform: scale(1.3);">
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="user_response_{{ $currentQuestionIndex }}"
                                        wire:model.live="userAnswers.{{ $currentQuestionIndex }}" value="0"
                                        class="mr-2" style="transform: scale(1.3);">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-10">
                                        <path stroke-linecap="round" stroke-linejoin="round"
