<div class="flex flex-col justify-center" translate="no">
    <div class="max-w-3xl bg-slate-500 rounded-lg shadow-lg mx-auto p-8">
        @if ($exam)
            ...
            @if ($exam->status == 'En attente')
                <div class="text-center">
                    <div class="bg-white rounded-lg shadow-lg mb-8 p-6">
                        <label class="text-l font-medium text-gray-700">Déroulement de l'examen</label>
